...
public class LoginActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pref.isLoggedIn()) {
            Intent intent = new Intent(LoginActivity.this, com.example.shafiqur.classreminder.studioTab.class);
    ...
    private void login() {
       ...
       // if (isValidEmail(email)) {
            ...
            //Intent intent = new Intent(LoginActivity.this, MainActivityParse.class);
        //created for redirect into tabbed view
